    ...
    <>
      <header
        style={{
          ...
          background:   'white',/*theme.colors.cream,*/
          borderBottom: `5px solid ${theme.colors.border}`,
      ...
      >
        ...
        <div
          style={{
            ...
            alignItems:     'center',
            padding:        isMobile ? '14px 24px 10px' : '5px 5px 5px',
        ...
        >
          <div onClick={() => handleNav('/')} style={{ cursor: 'pointer' }}>
            <img
              src={LOGO_URL}
              alt="Regatta"
              style={{ height: isMobile ? 56 : 150, width: 'auto', objectFit: 'cover', display: 'block' }}
            />
          </div>
        </div>
        ...
        <div
          style={{
            ...
            padding:        isMobile ? '10px 24px' : '0 50px',
